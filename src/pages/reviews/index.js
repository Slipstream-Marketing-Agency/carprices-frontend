            ...
            <div className="container">
                ...
                <div className="col-lg-8">
                    ...
                    <div className="news-img">
                        <Link legacyBehavior href="/reviews/test"><a><img src="assets/img/inner-page/blog-st-01.png" alt="" /></a></Link>
                        <div className="date">
                        <Link legacyBehavior href="/blog-standard"><a>Buying Advice</a></Link>
                        </div>
                    </div>
                    <div className="content">
                        <h4><Link legacyBehavior href="/reviews/test"><a>The Car Enthusiast: Exploring the World of Cars and Driving.</a></Link></h4>
                        ...
                        <Link legacyBehavior href="/reviews/test"><a className="view-btn">Read More</a></Link>
                        </div>
                    </div>
                    </div>
                    <div className="news-card2 mb-50">
                    ...
                    <div className="content">
                        <h4><Link legacyBehavior href="/reviews/test"><a>The Best Car Brands for Performance and Reliability.</a></Link></h4>
                        <p>"The Car Enthusiast: Exploring the World of Cars and Driving." In this captivating journey, we delve into the fascinating realm of automobiles.</p>
                        <div className="news-btm d-flex align-items-center justify-content-between">
                        <div className="author-area">
                            <div className="author-img">
                    ...
                    <div className="content">
                        <h4><Link legacyBehavior href="/reviews/test"><a>The Environmental Impact of Cars and How to Minimize It.</a></Link></h4>
                        <p>"The Car Enthusiast: Exploring the World of Cars and Driving." In this captivating journey, we delve into the fascinating realm of automobiles.</p>
                        <div className="news-btm d-flex align-items-center justify-content-between">
                        <div className="author-area">
                            <div className="author-img">
                    ...
                    <div className="single-widgets widget_egns_recent_post mb-20">
                        ...
                        <Swiper {...settings} className="swiper recent-post-sidebar-slider">
                            ...
                            <SwiperSlide className="swiper-slide">
                                ...
                                <div className="wi">
                                    <Link legacyBehavior href="/reviews/test"><a><img src="assets/img/inner-page/blog-st-01.png" alt="image" /></a></Link>
                                </div>
                                <div className="wc">
                                    <Link legacyBehavior href="/blog-standard"><a className="date">May 18, 2023</a></Link>
                                    <h6><Link legacyBehavior href="/reviews/test"><a>The Environmental Impact of Cars and How to Minimize It.</a></Link></h6>
                                </div>
                                </div>
                            </SwiperSlide>
                            <SwiperSlide className="swiper-slide">
                                <div className="widget-cnt">
                                <div className="wi">
                                    <Link legacyBehavior href="/reviews/test"><img src="assets/img/inner-page/blog-st-02.png" alt="image" /></Link>
                                </div>
                                <div className="wc">
                                    <Link legacyBehavior href="/blog-standard"><a className="date">May 18, 2023</a></Link>
                                    <h6><Link legacyBehavior href="/reviews/test"><a>The Environmental Impact of Cars and How to Minimize It.</a></Link></h6>
                            ...
                            <SwiperSlide className="swiper-slide">
                                <div className="widget-cnt">
                                <div className="wi">
                                    <Link legacyBehavior href="/reviews/test"><a><img src="assets/img/inner-page/blog-st-03.png" alt="image" /></a></Link>
                                </div>
                                <div className="wc">
                                    <Link legacyBehavior  href="/blog-standard"><a className="date">May 18, 2023</a></Link>
                                    <h6><Link legacyBehavior href="/reviews/test"><a>The Environmental Impact of Cars and How to Minimize It.</a></Link></h6>
