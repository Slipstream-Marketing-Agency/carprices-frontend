            ...
            <div className="inner">
              ...
              <div className="">
                ...
                <div className="find_specific ">
                  <p onClick={handleFilterSwitch}>Find your specific car</p>
                </div>
              </div>
            </div>
          </div>
