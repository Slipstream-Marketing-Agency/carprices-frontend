  ...
  return (
    ...
    <div className={`main-menu ${state.isSidebarOpen ? "show-menu" : ""}`}>
      ...
      <li className={`menu-item-has-children ${ currentRoute === "/" ? "active" : ""}`}>
                ...
                <li className="menu-single-item">
                  ...
                  <ul>
                    ...
                    <div className="explore-more-btn">
                      <Link legacyBehavior href="/brands"><a>Explore More <i className="bi bi-arrow-right" /></a></Link>
                    </div>
                  </ul>
                </li>
                <li className="menu-single-item">
        ...
        <li>
          <Link legacyBehavior href="/contact-us"><a  className="drop-down">CONTACT US</a></Link>
        </li>
      </ul>
